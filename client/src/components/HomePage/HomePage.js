...
import { nickname, typeOfGame } from '../../actions/index';
...
const HomePage = (props) => {
  ...
  const startGame = (type) => {
    if (name === '') alert('Enter a nickname');
    else {
      dispatch(nickname(name));
      props.history.push(`/loadingroom`);
    }
  };
            ...
            <div className='box'>
              ...
              <div className='box-container'>
                ...
                <p className='box-trivia-description'>
                  ...
                  Consectetur id natus ipsam architecto voluptates adipisci cum
                  eius accusamus quidem, repellat vitae possimus hic quibusdam
                  nam vel voluptas veritatis obcaecati ex.
                </p>
